...
(function () {
  ...
  function MainController($scope, $timeout) {
    ...
    var tabs = [
      ...
      {title: 'Administration', content: 'view/connexion.template.html', administrateur: true, professeur:false, responsable: false, eleve:false},
      {title: 'Evaluation', content: 'view/connexion.template.html', administrateur: true, professeur:true, responsable: false, eleve:false},
